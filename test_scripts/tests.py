...
test_cases = {
    "is_broken_hearts":
        [
         ...
         ("""submission.is_broken_hearts([('AD', 'JD', '3D', '6D'), ('0S', '2S', 'JS', '5S'), ('5H', '9H', '2H', 'QH'), ('3C', 'QC', '0C', 'KC'), ('4D', '9D', '8D', '7D'), ('2D', '8C', 'KD', '0D'), ('3S', '8S', '4S', '7S'), ('9S', '6S', 'AS', 'KS')], ('5H',))""", True), 
    ...
    "is_valid_play":
        [
         ...
         ("""submission.is_valid_play('KS', (), ['0D', '9S', '3S', '3D', '3H', '5D', 'AD', '6C', '7D', '6H', 'JH'], [])""", False),

         # can lead with heart in phase one
         ("""submission.is_valid_play('JH', (), ['0D', '9S', '3S', '3D', '3H', '5D', 'AD', '6C', '7D', '6H', 'JH'], [])""", True),
